...
class BCS_MimeTypes {
	public static $mime_types = array (
			...
			'bin' => 'application/octet-stream', 'bmp' => 'images/bmp',
			'cdf' => 'application/x-netcdf', 'cgm' => 'images/cgm',
			'class' => 'application/octet-stream',
			'cpio' => 'application/x-cpio',
			'cpt' => 'application/mac-compactpro',
			'csh' => 'application/x-csh', 'css' => 'text/css',
			'dcr' => 'application/x-director', 'dif' => 'video/x-dv',
			'dir' => 'application/x-director', 'djv' => 'images/vnd.djvu',
			'djvu' => 'images/vnd.djvu',
			...
			'gif' => 'images/gif', 'gram' => 'application/srgs',
			'grxml' => 'application/srgs+xml',
			'gtar' => 'application/x-gtar', 'gz' => 'application/x-gzip',
			'hdf' => 'application/x-hdf',
			'hqx' => 'application/mac-binhex40', 'htm' => 'text/html',
			'html' => 'text/html', 'ice' => 'x-conference/x-cooltalk',
			'ico' => 'images/x-icon', 'ics' => 'text/calendar',
			'ief' => 'images/ief', 'ifb' => 'text/calendar',
			'iges' => 'model/iges', 'igs' => 'model/iges',
			'jnlp' => 'application/x-java-jnlp-file', 'jp2' => 'images/jp2',
			'jpe' => 'images/jpeg', 'jpeg' => 'images/jpeg',
			'jpg' => 'images/jpeg', 'js' => 'application/x-javascript',
			'kar' => 'audio/midi', 'latex' => 'application/x-latex',
			'lha' => 'application/octet-stream',
			'lzh' => 'application/octet-stream',
			'm3u' => 'audio/x-mpegurl', 'm4a' => 'audio/mp4a-latm',
			'm4p' => 'audio/mp4a-latm', 'm4u' => 'video/vnd.mpegurl',
			'm4v' => 'video/x-m4v', 'mac' => 'images/x-macpaint',
			...
			'ogv' => 'video/ogv', 'pbm' => 'images/x-portable-bitmap',
			'pct' => 'images/pict', 'pdb' => 'chemical/x-pdb',
			'pdf' => 'application/pdf',
			'pgm' => 'images/x-portable-graymap',
			'pgn' => 'application/x-chess-pgn', 'pic' => 'images/pict',
			'pict' => 'images/pict', 'png' => 'images/png',
			'pnm' => 'images/x-portable-anymap',
			'pnt' => 'images/x-macpaint', 'pntg' => 'images/x-macpaint',
			'ppm' => 'images/x-portable-pixmap',
			'ppt' => 'application/vnd.ms-powerpoint',
			'ps' => 'application/postscript', 'qt' => 'video/quicktime',
			'qti' => 'images/x-quicktime', 'qtif' => 'images/x-quicktime',
			'ra' => 'audio/x-pn-realaudio',
			'ram' => 'audio/x-pn-realaudio', 'ras' => 'images/x-cmu-raster',
			'rdf' => 'application/rdf+xml', 'rgb' => 'images/x-rgb',
			...
			'sv4crc' => 'application/x-sv4crc', 'svg' => 'images/svg+xml',
			'swf' => 'application/x-shockwave-flash',
			't' => 'application/x-troff', 'tar' => 'application/x-tar',
			'tcl' => 'application/x-tcl', 'tex' => 'application/x-tex',
			'texi' => 'application/x-texinfo',
			'texinfo' => 'application/x-texinfo', 'tif' => 'images/tiff',
			'tiff' => 'images/tiff', 'tr' => 'application/x-troff',
			...
			'xbm' => 'images/x-xbitmap', 'xht' => 'application/xhtml+xml',
			'xhtml' => 'application/xhtml+xml',
			'xls' => 'application/vnd.ms-excel',
			'xml' => 'application/xml', 'xpm' => 'images/x-xpixmap',
			'xsl' => 'application/xml', 'xslt' => 'application/xslt+xml',
			'xul' => 'application/vnd.mozilla.xul+xml',
			'xwd' => 'images/x-xwindowdump', 'xyz' => 'chemical/x-xyz',
			'zip' => 'application/zip',
