<?php /* Smarty version Smarty-3.1.6, created on 2017-06-26 02:29:16
         compiled from "E:/phpwamp/wwwroot/StuTP/shop/Home/View\User\register.html" */ ?>
<?php /*%%SmartyHeaderCode:22935594aa18b4390b1-30321902%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '37ff2ef7cb2a2eebe2b40ae53cc6d30a1d3094e1' => 
    array (
      0 => 'E:/phpwamp/wwwroot/StuTP/shop/Home/View\\User\\register.html',
      1 => 1498239192,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '22935594aa18b4390b1-30321902',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_594aa18b79860',
  'variables' => 
  array (
    'errinfo' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_594aa18b79860')) {function content_594aa18b79860($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
...
<div class="header_bg">
    ...
    <form id="searchForm" method="get" action="#">
        ...
        <input name="imageField" value=" " class="go" style="cursor: pointer; background: url(" <?php echo @IMG_URL;?>
               ...
               sousuo.gif") no-repeat scroll 0% 0% transparent; width: 39px; height: 20px; border: medium none; float:
        left;
        margin-right: 15px; vertical-align: middle;" type="submit" />
...
" method="post">
                    <table cellpadding="5" cellspacing="3" style="text-align:left; width:100%; border:0;">
                        ...
                        <tr>
                            ...
                            <td style="width:87%;">
                                <input class="inputBg" size="25" name="username" id="User_username" type="text"
                                       value=""/>
                                <span style="color:red;"><?php echo $_smarty_tpl->tpl_vars['errinfo']->value['username'];?>
</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input class="inputBg" size="25" name="password" id="User_password"
                                       type="password" value=""/>
                                <span style="color:red;"><?php echo $_smarty_tpl->tpl_vars['errinfo']->value['password'];?>
</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input class="inputBg" size="25" name="password2" id="User_password2"
                                       type="password"/>
                                <span style="color:red;"><?php echo $_smarty_tpl->tpl_vars['errinfo']->value['password2'];?>
</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="inputBg" size="25" name="user_email" id="User_user_email"
                                       type="text" value=""/>
                                <span style="color:red;"><?php echo $_smarty_tpl->tpl_vars['errinfo']->value['user_email'];?>
</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input class="inputBg" size="25" name="user_qq" id="User_user_qq" type="text"
                                       value=""/>
                                <span style="color:red;"><?php echo $_smarty_tpl->tpl_vars['errinfo']->value['user_qq'];?>
</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input class="inputBg" size="25" name="user_tel" id="User_user_tel" type="text"
                                       value=""/>
                                <span style="color:red;"><?php echo $_smarty_tpl->tpl_vars['errinfo']->value['user_tel'];?>
</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <span id="User_user_sex">
                                            <input id="User_user_sex_0" value="1" checked="checked" type="radio"
                                                   name="user_sex"/>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span style="color:red;"><?php echo $_smarty_tpl->tpl_vars['errinfo']->value['user_xueli'];?>
</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <span id="User_user_hobby">
                                            <input id="User_user_hobby_0" value="1" type="checkbox"
                                                   name="user_hobby[]"/>
                                ...
                                <span style="color:red;"><?php echo $_smarty_tpl->tpl_vars['errinfo']->value['user_hobby'];?>
</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <textarea cols="50" rows="5" name="user_introduce"
                                          id="User_user_introduce"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
