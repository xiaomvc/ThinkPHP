...
<div class="header_bg">
    ...
    <form id="searchForm" method="get" action="#">
        ...
        <input name="imageField" value=" " class="go" style="cursor: pointer; background: url("{$smarty.const.IMG_URL}
        sousuo.gif") no-repeat scroll 0% 0% transparent; width: 39px; height: 20px; border: medium none; float: left;
                ...
                <form id="yw0" action="/index.php?r=user/register" method="post">
                    <table cellpadding="5" cellspacing="3" style="text-align:left; width:100%; border:0;">
                        ...
                        <tr>
                            ...
                            <td style="width:87%;">
                                <input class="inputBg" size="25" name="User[username]" id="User_username" type="text"
                                       value=""/>
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="inputBg" size="25" name="User[password]" id="User_password"
                                       type="password" value=""/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input class="inputBg" size="25" name="User[password2]" id="User_password2"
                                       type="password"/>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="inputBg" size="25" name="User[user_email]" id="User_user_email"
                                       type="text" value=""/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input class="inputBg" size="25" name="User[user_qq]" id="User_user_qq" type="text"
                                       value=""/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input class="inputBg" size="25" name="User[user_tel]" id="User_user_tel" type="text"
                                       value=""/>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea cols="50" rows="5" name="User[user_introduce]"
...
<div id="bottomNav" class="box block">
    <div class="box_1">
        <div class="links clearfix">
            <a href="#" target="_blank" title="YONGDA商城"><img src="{$smarty.const.IMG_URL}ecmoban_link.jpg" alt="YONGDA商城"
                                                              border="0"></a>
