<?php /* Smarty version Smarty-3.1.6, created on 2017-06-11 18:48:46
         compiled from "D:/phpwamp/wwwroot/StuTP/shop/Home/View\index\login.html" */ ?>
<?php /*%%SmartyHeaderCode:11106593d1da5e331b9-26047774%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e045111bac1e4156e0dad086a430a0e995c301e9' => 
    array (
      0 => 'D:/phpwamp/wwwroot/StuTP/shop/Home/View\\index\\login.html',
      1 => 1497178124,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11106593d1da5e331b9-26047774',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_593d1da61b7d5',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_593d1da61b7d5')) {function content_593d1da61b7d5($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
    ...
    <div id="topNav" class="clearfix">
        <div style="float: left;">
            <font id="ECS_MEMBERZONE">
                ...
                欢迎光临本店&nbsp;
                <a href="__MODULE__/User/login"> 登录</a>
                <a href="__MODULE__/User/register">注册</a>
            </font>
        </div>
...
<div class="header_bg">
    ...
    <form id="searchForm" method="get" action="#">
        ...
        <input name="imageField" value=" " class="go"
               style="cursor: pointer; background: url('<?php echo @IMG_URL;?>
sousuo.gif') no-repeat scroll 0% 0% transparent; width: 39px; height: 20px; border: medium none; float: left; margin-right: 15px; vertical-align: middle;"
               type="submit"/>
...
3_thumb_G_1241422082679.jpg" alt=""
                                                 class="samllimg"></a>
                            </li>
...
top_2.gif" class="iteration">
                            <li class="topimg">
                                <a href="#"><img src="<?php echo @IMG_URL;?>
24_thumb_G_1241971981429.jpg" alt=""
                                                 class="samllimg"></a>
                            </li>
...
top_3.gif" class="iteration">
                            <li class="topimg">
                                <a href="#"><img src="<?php echo @IMG_URL;?>
12_thumb_G_1241965978410.jpg" alt=""
                                                 class="samllimg"></a>
                            </li>
...
111.jpg" width="515" height="160" alt=""/>
            ...
            <div id="show_hot_area" class="clearfix">
                <div class="goodsItem">
                    ...
                    <a href="#"><img src="<?php echo @IMG_URL;?>
9_thumb_G_1241511871555.jpg" alt="诺基亚E66"
                                     class="goodsimg"></a><br/>
                ...
                <div class="goodsItem">
                    ...
                    <a href="#"><img src="<?php echo @IMG_URL;?>
1_thumb_G_1240902890710.jpg" alt="KD876"
                                     class="goodsimg"></a><br/>
                ...
                <div class="goodsItem">
                    ...
                    <a href="#"><img src="<?php echo @IMG_URL;?>
8_thumb_G_1241425513488.jpg" alt="飞利浦9@9v"
                                     class="goodsimg"></a><br/>
