...
/**
 * Represents an XHTML 1.1 model, with information on elements, tags
 * and attributes.
 ...
 * @note The public variables in a model should almost directly
...
class HTMLPurifier_HTMLModule
{
    ...
    /**
     * Short unique string identifier of the base.
     * @type string
     */
    public $name;

    /**
     * Informally, a list of elements this base changes.
     ...
     * the global collections. Example is the StyleAttribute base adding
    ...
    /**
     * Boolean flag whether or not this model is safe. If it is not safe, all
     ...
     *       or attributes, a dedicated model with this property set to false
     *       must be used.
     */
    public $safe = true;
    ...
    public function addBlankElement($element)
    {
        if (!isset($this->info[$element])) {
            ...
            trigger_error("Definition for $element already exists in base, cannot redefine");
        }
        return $this->info[$element];
    }
    ...
    public function parseContents($contents)
    {
        ...
        switch ($contents) {
            // check for shorthand content base forms
            case 'Empty':
                return array('empty', '');
            case 'Inline':
    ...
    /**
     * Lazy load construction of the base after determining whether
