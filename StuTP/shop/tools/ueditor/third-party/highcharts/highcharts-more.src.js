...
// JSLint options:
/*global Highcharts, HighchartsAdapter, document, window, navigator, setInterval, clearInterval, clearTimeout, setTimeout, manager, jQuery, $, console */
...
seriesTypes.bubble = extendClass(seriesTypes.scatter, {
	...
	/**
	 * Extend the model translate method to handle bubble size
	 */
	translate: function () {
