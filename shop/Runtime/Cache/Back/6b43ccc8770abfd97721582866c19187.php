...
<table height="100%" cellspacing=0 cellpadding=0 width=170
    ...
    <tr>
        <td valign=top align=middle>
            ...
            <?php if(is_array($authA)): foreach($authA as $key=>$v): ?><table cellspacing=0 cellpadding=0 width=150 border=0>
                ...
                <table id='child<?php echo ($v["auth_id"]); ?>' style="display: none" cellspacing=0 cellpadding=0
                    ...
                    <?php if(is_array($authB)): foreach($authB as $key=>$vv): if($v['auth_id'] == $vv['auth_pid']): ?><tr height=20>
                               <td align=middle width=30><img height=9
                                                              src="<?php echo (C("BACK_IMG_URL")); ?>menu_icon.gif" width=9></td>
                               <td><a class=menuchild
                                      href="/index.php/Back/<?php echo ($vv["auth_c"]); ?>/<?php echo ($vv["auth_a"]); ?>"
                                      target='right'><?php echo ($vv["auth_name"]); ?></a></td>
