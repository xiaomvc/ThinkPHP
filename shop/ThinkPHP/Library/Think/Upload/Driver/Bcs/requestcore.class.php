...
class BCS_RequestCore {
	...
	/**
	 * The default class to use for HTTP Requests (default to <BCS_RequestCore>).
	 */
	public $request_class = 'BCS_RequestCore';
	/**
	 * The default class to use for HTTP Responses (default to <BCS_ResponseCore>).
	 */
	 ...
	 *
	 * @param array $curlopts (Optional) A set of key-value pairs that set `CURLOPT` options. These will merge with the existing CURLOPTs, and ones passed here will override the default. Keys should be the `CURLOPT_*` constants, not strings.
	 * @return $this A reference to the current instance.
	 */
	 ...
	 *
	 * @param string $location (Required) The readable manager to read from.
	 * @return $this A reference to the current instance.
	 */
	 ...
	 *
	 * @param string $location (Required) The writeable manager to write to.
	 * @return $this A reference to the current instance.
	 */
