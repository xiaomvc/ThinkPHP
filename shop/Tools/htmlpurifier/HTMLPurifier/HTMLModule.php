...
class HTMLPurifier_HTMLModule
{
    ...
    /**
     * Short unique string identifier of the model.
     * @type string
     */
    public $name;

    /**
     * Informally, a list of elements this model changes.
     ...
     * the global collections. Example is the StyleAttribute model adding
    ...
    public function addBlankElement($element)
    {
        if (!isset($this->info[$element])) {
            ...
            trigger_error("Definition for $element already exists in model, cannot redefine");
        }
        return $this->info[$element];
    }
    ...
    /**
     * Lazy load construction of the model after determining whether
