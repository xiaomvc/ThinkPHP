...
/**
 * XHTML 1.1 Legacy model defines elements that were previously
 * deprecated.
 *
 * @note Not all legacy elements have been implemented yet, which
 *       is a bit of a reverse problem as compared to browsers! In
 *       addition, this legacy model may implement a bit more than
 *       mandated by XHTML 1.1.
 *
 * This model can be used in combination with TransformToStrict in order
...
class HTMLPurifier_HTMLModule_Legacy extends HTMLPurifier_HTMLModule
{
    ...
    public function setup($config)
    {
        ...
        // attribute, make a new TrustedLegacy model with the trusted
