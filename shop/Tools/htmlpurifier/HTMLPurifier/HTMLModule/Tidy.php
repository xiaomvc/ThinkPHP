...
class HTMLPurifier_HTMLModule_Tidy extends HTMLPurifier_HTMLModule
{
    ...
    /**
     * Lazy load constructs the model by determining the necessary
    ...
    public function setup($config)
    {
        ...
        // populate this model with necessary fixes
        $this->populate($fixes);
    }
    ...
    /**
     * Populates the model with transforms and other special-case code
    ...
    /**
     * Defines all fixes the model will perform in a compact
