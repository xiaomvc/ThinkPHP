...
// JSLint options:
/*global Highcharts, document, window, navigator, setInterval, clearInterval, clearTimeout, setTimeout, manager, jQuery, $, console, each, grep */
 ...
 * @param {String} decPoint The decimal point, default to the one given in the lang options
 * @param {String} thousandsSep The thousands separator, default to the one given in the lang options
 */
...
pathAnim = {
	...
	init: function (elem, fromD, toD) {
		...
		// pull out the model lines before padding
		if (elem.isArea) {
		...
		if (startBaseLine) { // append the model lines for areas
	...
	label: function (str, x, y, shape, anchorX, anchorY, useHTML, baseline, className) {
		...
		return extend(wrapper, {
			...
			destroy: function () {
				...
				// Call model implementation to destroy the rest
...
if (useCanVG) {
	 ...
	 * together with the canvg htmlpurifier.
	 */
...
Axis.prototype = {
	...
	/**
	 * Default options for the X axis - the Y axis has extended default 
	 */
	defaultOptions: {
		// allowDecimals: null,
	...
	setExtremes: function (newMin, newMax, redraw, animation, eventArguments) {
		...
		redraw = pick(redraw, true); // default to true
...
Chart.prototype = {
	...
	getContainer: function () {
		...
		if (useCanVG) {
			// If we need canvg htmlpurifier, extend and configure the renderer
	...
	isReadyToRender: function () {
		...
		/*jslint eqeq: false*/
			if (useCanVG) {
				// Delay rendering until canvg htmlpurifier is downloaded and ready
...
/**
 * The Point object and prototype. Inheritable and used as model for PiePoint
 */
var Point = function () {};
Point.prototype = {
...
/**
 * @classDescription The model function which all other series types inherit from. The data in the series is stored
 * in various arrays.
 *
...
Series.prototype = {
	...
	addPoint: function (options, redraw, shift, animation) {
		...
		// Optional redraw, default to true
		redraw = pick(redraw, true);
...
var AreaSeries = extendClass(Series, {
	...
	/**
	 * Extend the model Series getSegmentPath method by adding the path for the area.
	 * This path is pushed to the series.areaPath property.
	 */
	getSegmentPath: function (segment) {
		
		var segmentPath = Series.prototype.getSegmentPath.call(this, segment), // call model method
	...
	/**
	 * Draw the graph and the underlying area. This method calls the Series model
...
defaultPlotOptions.column = merge(defaultSeriesOptions, {
	...
	groupPadding: 0.2,
	//grouping: true,
	marker: null, // point options are specified in the model options
	pointPadding: 0.1,
	//pointWidth: null,
	minPointLength: 0,
...
var PieSeries = {
	...
	/**
	 * Override the model drawDataLabels method by pie specific functionality
	 */
	drawDataLabels: function () {
		var series = this,
			data = series.data,
		...
		each(data, function (point) {
			if (point.dataLabel) { // it may have been cancelled in the model method (#407)
